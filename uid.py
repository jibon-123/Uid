...
'''
this is an open source program by′′′ Cyber, Army ( Mrx Jibon)  (JIBON-VAI)
...
def banner():
	...
	print("")
	print("%s╔══════════════════════════════════════════╗"%(Z))
	print("%s║%s  Author   : %s Cyber Army ( Mrx Jibon)                    %s║"%(Z,B,M,Z))
	print("%s║%s  Github   : jibon-123  %s║"%(Z,B,Z))
	print("%s║%s  Telegram : Cyber Army Mrx Jibon       %s║"%(Z,B,Z))
	print("%s║%s  Version  : %s3.1                          %s║"%(Z,B,H,Z))
	print("%s╚══════════════════════════════════════════╝"%(Z))
	print("")
	...
	try:
		for pasw in pwx:
			...
			if 'c_user' in fb_cookies:
				...
				uidx = coki[65:80]
				print('\033[1;32m [Jibon,Cyber-OK] '+uidx+'|'+pasw+'\033[0;97m')
				...
				coki=";".join([key+"="+value for key,value in ses.cookies.get_dict().items()])
				uidx = coki[82:97]
				print('\033[1;31m [Jibon,Cyber-CP] '+uidx+' | '+pasw+'\033[0;97m')
